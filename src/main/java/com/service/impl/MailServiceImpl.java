...
public class MailServiceImpl implements MailService {
    ...
    public static final String mailTemplateFolder = "/mail-template/";

    private Logger mailLogger = LoggerFactory.getLogger(MailService.class);
    ...
    public String getMailContent(String template, Map<String, Object> content) {
        Context context = new Context();
        context.setVariables(content);
        return templateEngine.process(mailTemplateFolder + template, context);
    }
    ...
    public void sendMail(String template, String to, String subject, Map<String, Object> content) throws MessagingException {
        ...
        String contentHtml = templateEngine.process(mailTemplateFolder + template, context);
